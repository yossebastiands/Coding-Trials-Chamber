 ...
 * @version 1.0
 */
public class PaintingBasic {
	private ArrayList<Position> positions = new ArrayList<Position> (); // Positionsangaben der Figur
	 ...
	 * 
	 * Alte Positionsangaben werden gel scht und die aktuelle Position gesetzt. 
	 * 
